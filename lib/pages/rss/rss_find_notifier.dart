...
class RssFindNotifier extends StateNotifier<List<RssSourcesModel>> {
  final IRssRepository repository;

  RssFindNotifier({required this.repository}) : super([]);
...
final rssFindProvider =
    StateNotifierProvider.autoDispose<RssFindNotifier, List<RssSourcesModel>>(
        (ref) {
